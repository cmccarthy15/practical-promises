...
function problemB () {
  ...
  .then(
    function(value) {blue(value); return promisifiedReadFile('poem-one/stanza-03.txt');})
  .then(
    function(value) {blue(value);}
  );
}
...
function problemE () {
  ...
  .then(
    function(value) {blue(value); return promisifiedReadFile('poem-one/wrong-file-name.txt');})
  .then(
    function(value) {blue(value);}
  )
  .catch(
...
function problemF () {
  ...
  .then(
    function() {console.log('done!');},
    function(err) {magenta(err); console.log('done!');}
  );
